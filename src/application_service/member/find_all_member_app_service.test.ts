...
import type { DiscoverableMemberQueryResult } from "./i_find_discoverable_members_query_service";
...
class StubFindDiscoverableMembersQueryService implements IFindDiscoverableMembersQueryService {
  ...
  constructor(private readonly result: DiscoverableMemberQueryResult[] = []) {}
    ...
    expect(result).toEqual([
      {
        ...
        hasLiked: false,
        topImageUrl:
          "http://localhost:3000/api/v1/media/members/00000000-0000-4000-8000-000000000002/top.webp",
      },
    ]);
  });
